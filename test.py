...
def diffMask(img1=None,img2=None,opt=None,dataset=None,args=None):
	...
	plt.imsave("{}/{}_{}_ref.jpg".format(save_ref,f,img1[:-6]),resize(plt.imread("/content/drive/MyDrive/Anju/poly_gan/data/data/{}/image/{}_0.jpg".format(opt.datamode,img1[:-6])),(128,128)))
